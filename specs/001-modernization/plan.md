...
Current: the modernization branch is pushed for PR review and live CI. Cabal/Nix, documentation and Spec Kit setup are implemented; nine tests and the example are required, including from the rebuilt source archive. Two compiled mutations confirm dependency traversal and failed-prerequisite coverage.
